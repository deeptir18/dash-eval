...
$DASH/target/release/shell-exec $DASH_EVAL/apps/ray_tracing/dash/app.sh --mount_file $DASH/config/pancham.mount --annotations_file $DASH/config/eval_annotations.txt
